  ...
  [5142, 766, 2874],
  {
          ...
          u = (0, r.useRef)(null),
          {
            ...
            return {
              ...
              getPosition: function (e) {
                return (0, P.calcSubMenuPos)(e.contentWidth, t.current);
              },
              onMenuMouseOver: n,
      ...
      class O {
        ...
        async send(e) {
          if (this._status === T.PlaceOrEditContextStatus.Error)
            return (
              this._processError(new Error(Object.values(this._errors)[0])),
              !1
            );
    ...
    529719: (e, t, i) => {
      ...
      function m(e) {
        ...
        return (
          e.subscribe(i),
          { subject: t, unsubscribe: () => e.unsubscribe(i) }
        );
      }
      function _(e, t) {
        ...
        constructor() {
          (super(...arguments),
            ...
            (this._updatePositionPLHandler =
              this._updatePositionPL.bind(this)));
        }
        destroy() {
          this.stopService();
        }
    ...
    974945: (e, t, i) => {
      "use strict";
      (i.r(t),
        i.d(t, { Trading: () => Qi, showSellBuyButtonsDefault: () => $i }));
      var r = i(650151),
        s = i(609838),
        o = i(870122),
        n = i(376202),
      ...
      class Pe {
              ...
              : this._noConfirmEnabled.value()
                ...
                : this._activeBroker.positionById(e).then((t) => {
                    if (!this._activeBroker)
                      return Promise.reject(
                        "Broker connection adapter is null",
                      );
        ...
        async _closePositionForNonTradableSymbol(e) {
          ...
          if (!t || !r) {
            ...
            return (
              this._showErrorNotification(t, s.t(null, void 0, i(348434))),
              !1
            );
          }
          return (
        ...
        async _cancelOrderForNonTradableSymbol(e, t) {
          if (
            ...
            return (
              this._showErrorNotification(t, s.t(null, void 0, i(30665))),
              !1
            );
          }
      ...
      class Ct {
        ...
        async tryToPlaceSellOrder() {
          await this._tryToPlaceOrder(
            parseFloat((0, r.ensureNotNull)(this.bid.value())),
            -1,
          );
        }
        async tryToPlaceBuyOrder() {
          await this._tryToPlaceOrder(
            parseFloat((0, r.ensureNotNull)(this.ask.value())),
            1,
          );
        }
        async getQtyInfo() {
      ...
      var Nt = i(190787),
        ...
        Rt = i(844012),
        Ft = i(829883);
      const Wt = parseInt(Rt["css-value-padding"]);
      function qt(e, t, i, s) {
      ...
      class Ut {
        ...
        _render() {
          ...
          (this._buyButtonTextEl.appendChild(
      ...
      class li extends Gt.DialogRenderer {
        ...
        _renderOfflineScreen() {
          ((this._title = ai),
            this._changeDialogContent(
              be.createElement(Kt.OfflineScreen, null),
            ));
        }
      ...
      class wi {
        constructor(e) {
          ((this._rawAndFilteredQtyMap = new Map()),
            (this._qtyInfo = new Map()));
          const {
            symbolInfoGetter: t,
            onResetNeeded: i,
        ...
        constructor(e) {
          ((this._onSymbolChange = (e) => {
            ...
            (this._processSymbol = async (e, t) => {
              ...
              null == e ||
                e.addEventListener("abort", () => i.unsubscribe(), {
                  once: !0,
                });
            }),
      ...
      class Qi {
        ...
        _makeSubAction({
          ...
          const c = 1 === t ? "Trading.Buy" : "Trading.Sell",
            ...
            g = d + u,
            m = {
              BuyLimit: s.t(null, void 0, i(302122)).format({
                symbol: p,
                qty: (0, F.abbreviatedNumber)(a),
                value: o.formattedPrice,
              }),
              SellStop: s.t(null, void 0, i(627392)).format({
                symbol: p,
                qty: (0, F.abbreviatedNumber)(a),
                value: o.formattedPrice,
              }),
              SellLimit: s.t(null, void 0, i(476678)).format({
                symbol: p,
                qty: (0, F.abbreviatedNumber)(a),
                value: o.formattedPrice,
              }),
              BuyStop: s.t(null, void 0, i(255481)).format({
                symbol: p,
                qty: (0, F.abbreviatedNumber)(a),
                value: o.formattedPrice,
              }),
          ...
          return (
            h &&
              ((m.SellStopLimit = s.t(null, void 0, i(194240)).format({
                symbol: p,
                qty: (0, F.abbreviatedNumber)(a),
                value: o.formattedPrice,
                altValue: o.formattedAltPrice,
              })),
              (m.BuyStopLimit = s.t(null, void 0, i(353343)).format({
                symbol: p,
                qty: (0, F.abbreviatedNumber)(a),
                value: o.formattedPrice,
                altValue: o.formattedAltPrice,
    ...
    481330: (e, t, i) => {
      ...
      function N(e, t) {
        ...
        return e.filter((e) => {
          var r;
          const s =
            null !== (r = e.supportedOrderTypes) && void 0 !== r ? r : i;
