  ...
  [8951],
  {
        ...
        switch (t.type) {
          ...
          case i.ActionType.UpdateEditorValue:
            var W = (H = o(O)).findIndex(function (e) {
                return (
                  e.columnKey === t.columnKey && e.rowKeyValue === t.rowKeyValue
                );
              }),
          ...
          case i.ActionType.SaveNewRow:
            var pe = t.type === i.ActionType.SaveNewRow,
              ...
              he = O.filter(function (e) {
                return (
                  e.rowKeyValue === ge &&
                  (pe || e.hasOwnProperty("editorValue"))
                );
              });
            if (t.validate) {
              var ye = !0;
    ...
    294349: function (e, t, r) {
      ...
      ((t.getField = function (e) {
        ...
        (t.getLastField = function (e) {
          return o.default.fieldDelimiter
            ? e.split(o.default.fieldDelimiter).pop()
            : e;
        }),
        (t.getFieldParts = function (e) {
          return o.default.fieldDelimiter
            ? e.split(o.default.fieldDelimiter)
            : [e];
        }),
        ...
        (t.getDraggableProps = function (e, t, r, n, o) {
          ...
          return {
            ...
            onDrop: function (n) {
              ...
              var a = JSON.parse(
                n.dataTransfer.getData("ka-draggableKeyValue"),
              );
              t(r(a, e));
            },
    ...
    30493: function (e, t, r) {
      ...
      var a = function (e, r, n, i) {
        ...
        if (!u)
          return [
            { treeDataMark: t.treeDataMark, rowData: e, treeDeep: i + 1 },
          ];
