(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2824],
  {
    ...
    168233: (e, t, n) => {
      "use strict";
      n.d(t, { EmojiListContent: () => h, EmojiListContentContext: () => d });
      var r = n(50959),
        o = n(220037),
        a = n(497754),
        l = n.n(a),
      ...
      function c(e) {
        ...
        return r.createElement("div", { className: l()(i.wrapper, n) }, t);
      }
      var s = n(723407),
        m = n(840976),
        u = n(710263),
      ...
      function h(e) {
        ...
        const f = (0, r.useCallback)(
          ...
          E = Math.min(h - 102, window.innerHeight - 102);
        return r.createElement(
          d.Provider,
          {
            value: (0, r.useMemo)(
      ...
      function d(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            "div",
            { ref: k, onKeyDown: z },
            r.createElement(c.EmojiListContent, {
              listRef: g,
              outerRef: b,
              emojiGroups: M,
              emojiSize: E,
    ...
    723407: (e, t, n) => {
      ...
      const c = r.memo((e) => {
        ...
        return r.createElement(
          "div",
          { "data-role": "row", className: a()(i.wrapper, s) },
          t.map((e) =>
            r.createElement(l.EmojiWrap, {
              key: e,
              className: i.emojiItem,
              emoji: e,
              size: n,
              onClick: o,
              ItemComponent: c,
    ...
    65559: (e, t, n) => {
      ...
      function m(e) {
        const {
          ...
          [u, v] = (0, i.useRovingTabindexElement)(null);
    ...
    543454: (e, t, n) => {
      ...
      function c(e) {
        return r.createElement(
          "div",
          { className: a()(i.wrapper, e.className) },
          r.createElement(l.Icon, { icon: e.icon }),
        );
      }
    },
    134640: (e, t, n) => {
      ...
      function c(e) {
        const { emoji: t, className: n } = e,
          o = (0, l.getTwemojiUrl)(t, "png");
        return r.createElement("img", {
          className: a()(n, i.emoji),
          src: o,
          decoding: "async",
          width: "24",
          height: "24",
    ...
    179807: (e, t, n) => {
      ...
      function c(e) {
        ...
        const c = v(e.currentTarget).sort(r.navigationOrderComparator);
        ...
        const p = d(s),
          ...
          w = -1 !== f,
          E = (e) => {
            (i && (0, o.becomeSecondaryElement)(i),
        ...
        switch ((0, r.mapKeyCodeToDirection)(n)) {
          case "inlinePrev":
            if (!p.length) return;
            (e.preventDefault(),
              E(0 === f ? c[h] : w ? m(p, f, -1) : p[p.length - 1]));
            break;
          case "inlineNext":
            if (!p.length) return;
            (e.preventDefault(),
              f === p.length - 1 ? E(c[h]) : E(w ? m(p, f, 1) : p[0]));
            break;
          case "blockPrev": {
            e.preventDefault();
            const t = m(c, h, -1);
    ...
    622614: (e, t, n) => {
      ...
      const u = (0, r.forwardRef)(function (e, t) {
        const {
          ...
          p = i.PLATFORM_ACCESSIBILITY_ENABLED
        ...
        return (
          (0, r.useLayoutEffect)(() => {
            ...
            const e = (0, o.ensureNotNull)(f.current),
              t = () => {
                const t = (0, i.queryTabbableElements)(e).sort(
                  i.navigationOrderComparator,
                );
                if (0 === t.length) {
                  const [t] = (0, i.queryFocusableElements)(e).sort(
                    i.navigationOrderComparator,
                  );
                  if (void 0 === t) return;
          ...
          r.createElement("div", {
            ...
            onKeyDown: (0, a.createSafeMulticastEventHandler)(function (e) {
              ...
              const n = e.currentTarget,
                r = (0, i.queryFocusableElements)(n).sort(
                  i.navigationOrderComparator,
                );
