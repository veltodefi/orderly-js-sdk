...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7898],
  {
          ...
          ((this._symbolDataHandlers = new Map()),
            ...
            (this._quoteSessionDataHandler = (t) => {
              const e = (0, o.ensureDefined)(t.symbolname),
                { filtered: s, keepSubscription: r } =
                  this._applyDataFilters(t);
              (r || this._unsubscribeSymbols([e]),
                this._setSymbolDataCache(e, s));
      ...
      const l = new (class {
        ...
        get(t, e = "watchlist") {
          ...
          if (o) {
            ...
            r
              ? (s = r)
              : ((s = new i(t, this._lastSymbolData, e)), o.set(e, s));
          } else {
    ...
    363940: (t, e, s) => {
      ...
      const L = (0, d.respectLatest)(function (t) {
        const e = (0, i.service)(l.SYMBOL_LIST_REPOSITORY_BACKEND_SERVICE);
        return async (s, o) => {
          try {
      ...
      const k = (0, d.respectLatest)(function (t) {
        const e = (0, i.service)(l.SYMBOL_LIST_REPOSITORY_BACKEND_SERVICE);
        return async (s, o) => {
          try {
    ...
    607898: (t, e, s) => {
      ...
      const k = (0, m.respectLatest)(function (t, e, r, i) {
        return async (a, u) => {
          try {
            ...
            if ((a(B(null, y)), r)) {
              ...
              if (!t) return;
              await a(
                _((0, o.ensureDefined)(e.symbols), (0, o.ensureDefined)(t)),
              );
            }
          } catch (t) {
            (0, m.skipAbortError)(t);
    ...
    706474: (t, e, s) => {
      ...
      function E(t, e, s, o) {
        let r = parseFloat(T(String(t))),
          n = parseFloat(T(String(e)));
