(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7260],
  {
    ...
    729624: (e, t, s) => {
      ...
      function p(e) {
        ...
        return a
          ? r.createElement(
              "li",
              { className: n()(t, m.item, m.loading, m[w]) },
          ...
          : r.createElement(
              ...
              !D &&
                k &&
                r.createElement(c.Hint, { className: m.shortcut, text: k }),
              D && r.createElement(i.Icon, { className: m.nested, icon: h }),
              z,
            );
      }
    },
    ...
    452015: (e, t, s) => {
      "use strict";
      (s.r(t), s.d(t, { BottomToolbarRenderer: () => kt }));
      var r = s(50959),
        a = s(500962),
        n = s(609838),
        i = s(719036),
      ...
      const k = (e) =>
        ...
        C = {
          1: { resolution: "1", text: k(1) },
          3: { resolution: "3", text: k(3) },
          5: { resolution: "5", text: k(5) },
          15: { resolution: "15", text: k(15) },
          30: { resolution: "30", text: k(30) },
          45: { resolution: "45", text: k(45) },
          ...
          "1D": {
            ...
            text:
              ...
              n.t(
                null,
                { plural: "{str} days", count: M, replace: { str: `${M}` } },
                s(774262),
              )),
          },
          "1W": {
            ...
            text:
              ...
              n.t(
                null,
                { plural: "{str} weeks", count: z, replace: { str: `${z}` } },
                s(14074),
              )),
          },
      ...
      function T(e) {
        const t = (function (e) {
            ...
            if (!r.isValid()) {
              if ("YTD" === t)
                return n.t(null, { context: "timeframe_title" }, s(987556));
              if ("ALL" === t)
                return n.t(null, { context: "timeframe_title" }, s(574944));
      ...
      function U(e) {
        ...
        return r.createElement(
          r.Fragment,
          null,
          r.createElement(B.Separator, { className: P.separator }),
          r.createElement(j.ContextMenuItem, {
            icon: R,
      ...
      function V(e) {
        return class extends r.PureComponent {
          ...
          render() {
            ...
            return r.createElement(
              "div",
              { className: o(t, Y.tabs), "data-name": this.props["data-name"] },
              s,
              r.createElement(e, {
                reference: (e) => {
                  this._slider = e;
          ...
          ((this._tickInterval = setInterval(this._tickClock, 1e3)),
            e.withModel(null, () => {
              ...
              (t
                ...
                ye.timeHoursFormatProperty.subscribe(
                  this,
          ...
          (clearInterval(this._tickInterval),
            e.withModel(null, () => {
              ...
              (t
                ...
                ye.timeHoursFormatProperty.unsubscribe(
                  this,
                  this._timeHoursFormatPropertyChanged,
                ));
            }));
      ...
      function ze(e) {
        return r.createElement("span", {
          className: o(Ee.separator, e.className),
        });
      }
      var Me = s(622614),
        Te = s(664902),
      ...
      const De = (0, b.registryContextType)(),
        Ie = new Te.TranslatedString(
          "toggle log scale",
          n.t(null, void 0, s(160166)),
        );
      const Le = (0, b.registryContextType)(),
        We = new Te.TranslatedString(
          "toggle auto scale",
          n.t(null, void 0, s(863060)),
        );
      const je = (0, b.registryContextType)(),
        Be = new Te.TranslatedString(
          "toggle percentage scale",
          n.t(null, void 0, s(568642)),
        );
      ...
      var Re = s(670086),
        ...
        Ue = s(471453),
        Fe = s(97086);
      const Oe = new Te.TranslatedString(
          "change session",
          n.t(null, void 0, s(765303)),
        ),
        Je = {
          hint: n.t(null, void 0, s(25866)),
          headerMenuText: n.t(null, void 0, s(644794)),
        },
      ...
      var Ge = s(557883),
        ...
        qe = s(747633),
        Ze = s(21212);
      const $e = (0, b.registryContextType)();
      class Ke extends r.PureComponent {
          ...
          (super(e, t),
            (this._handleClick = () => {
              const { resizerDetacher: e, chartWidgetCollection: t } =
                this.context;
              (t.setViewMode(Ge.CollectionViewMode.Multichart),
                e.exitFullscreen());
            }),
            (0, b.validateRegistry)(t, {
              chartWidgetCollection: i.any.isRequired,
        ...
        render() {
          ...
          return r.createElement(qe.ToolWidgetButton, {
            icon: Ze,
            className: e,
            onClick: this._handleClick,
          });
        ...
        at =
          ((nt = (e) =>
            r.createElement(Z.ToolbarButton, {
              ...
              onClick: gt(e.onClick, "log", e.isLogarithm),
              onMouseEnter: e.onMouseEnter,
              onMouseLeave: e.onMouseLeave,
              "data-name": "logarithm",
            })),
          ((it = class extends r.PureComponent {
            constructor(e, t) {
              (super(e, t),
                ...
                (this._handleSelect = () => {
                  ...
                  t.priceScale().isLockScale() ||
                    e.setPriceScaleMode({ log: !r.log }, s, Ie);
                }),
                (0, b.validateRegistry)(t, { chartWidget: i.any.isRequired }),
      ...
      const ot = (function (e) {
          ...
          r.createElement(Z.ToolbarButton, {
            ...
            onClick: gt(e.onClick, "auto", e.isAuto),
            onMouseEnter: e.onMouseEnter,
            onMouseLeave: e.onMouseLeave,
            "data-name": "auto",
          }),
        ...
        lt = (function (e) {
          ...
          r.createElement(Z.ToolbarButton, {
            icon: Qe,
            tooltip: rt.percentageHint,
            className: e.className,
            isActive: e.isPercentage,
            "aria-pressed": e.isPercentage,
            isDisabled: e.isDisabled,
            onClick: gt(e.onClick, "percent", e.isPercentage),
            onMouseEnter: e.onMouseEnter,
            onMouseLeave: e.onMouseLeave,
            "data-name": "percentage",
          }),
        );
      const ct = (0, ae.hotKeySerialize)({
        ...
        dt = (function (e) {
          ...
          r.createElement(Z.ToolbarButton, {
            icon: e.isFullscreen ? tt : et,
            tooltip: rt.fullscreenHint,
            className: e.className,
            isActive: e.isFullscreen,
            onClick: gt(e.onClick, "maximize chart", e.isFullscreen),
            "data-tooltip-hotkey": ct,
            "data-name": "fullscreen",
          }),
        ),
        ht = { fullscreen: !0, preventPhoneLayout: !0 },
        ut = {
      ...
      class bt extends r.PureComponent {
                ...
                if (r.isValidElement(e) && "string" != typeof e.type) {
                  ...
                  if ("string" == typeof i.className) {
                    const l = {
                        className: o(
                          i.className,
                          t === a.length - 1 && st.last,
                        ),
                      },
                      c = s(),
                      d = (0, v.ensureDefined)(mt.get(e.type));
                    return r.createElement(
                      "div",
                      {
                        key: null === e.key ? void 0 : e.key,
                        className: o(st.inline, c[d] && st.collapsed),
                        ref: (e) => n(e, d),
                        onClick: () => pt(),
                      },
                      r.cloneElement(e, l),
        ...
        render() {
          ...
          return r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  "div",
                  {
                    className: o(
                      st.dateRangeWrapper,
                      "collapsed" !== e.dateRangeMode && st.collapsed,
                    ),
                    ref: this._handleRangeCollapsedRef,
                  },
                  r.createElement(
                    "div",
                    { className: o(st.dateRangeCollapsed) },
                    r.createElement(X, {
                      goToDateButton: this.props.goToDateEnabled,
                      className: st.dateRange,
                    }),
                  ),
                ),
                r.createElement(
                  "div",
                  {
                    className: o(
                      st.dateRangeWrapper,
                      "expanded" !== e.dateRangeMode && st.collapsed,
                    ),
                    ref: this._handleRangeExpandedRef,
                  },
                  r.createElement(
                    "div",
                    { className: o(st.dateRangeExpanded) },
                    r.createElement(re, {
                      onSelectRange: this._trackRangeButtonClick,
                      className: st.dateRange,
                    }),
                    this.props.goToDateEnabled && r.createElement(ze, null),
            ...
            r.createElement(
              "div",
              { className: st.seriesControlWrapper },
              s &&
                r.createElement(
                  "div",
                  {
                    className: o(st.inline, e.timeZones && st.collapsed),
              ...
              this.props.sessionIdButtonEnabled &&
                ...
                r.createElement(
                  "div",
                  {
                    className: o(st.inline, e.session && st.collapsed),
              ...
              r.createElement(
                "div",
                {
                  ...
                  className: o(st.inline, e.separator && st.collapsed),
                },
              ...
              r.createElement(
                ...
                a &&
                  ...
                  r.createElement(lt, { className: st.item }),
                n && r.createElement(at, { className: st.item }),
                i && r.createElement(ot, { className: st.item }),
                l &&
                ...
                this.props.fullscreenButtonEnabled &&
                  ...
                  r.createElement(Ke, { className: st.item }),
              ),
            ),
          );
        }
            ...
            if ("separator" !== a) {
              ...
              e &&
                ("timeZones" === a || "session" === a
                  ? (s = s || !n)
                  : (r = r || !n),
                e.classList.toggle(st.collapsed, n));
            }
          });
          const a = this._seriesComponents.separator;
          if (a) {
            const e = !s || !r || !0 === t.separator;
            a.classList.toggle(st.collapsed, e);
          }
        }
        _isPreventPhoneLayoutButton() {
          {
            ...
            return (
              ...
              we.CheckMobile.any() &&
              Ve.mediaState.isPhoneSizeDevice() &&
              e.viewMode.value() === Ge.CollectionViewMode.ForceFullscreen
            );
          }
        }
      }
      ...
      class ft extends r.PureComponent {
        ...
        render() {
          ...
          return r.createElement(
            b.RegistryProvider,
            { validation: yt, value: this._registry },
            r.createElement(bt, { key: e.id(), ...s }),
          );
        }
        _defineRegistry(e) {
          const {
