  ...
  [660],
  {
    ...
    721678: (e, t, i) => {
        ...
        Q = (function (e) {
          ...
          return (
            ...
            (t.prototype.requestAsyncId = function (e, t, i) {
              return (
                void 0 === i && (i = 0),
                A.setInterval(e.flush.bind(e, this), i)
              );
            }),
        ...
        return (
          ...
          (0, H.operate)(function (e, t) {
            var i = !1,
              ...
              c = function (e) {
                return (o = (0, k.innerFrom)(s(e)).subscribe(
      ...
      function ae() {
        ...
        return (0, H.operate)(function (t, s) {
          for (
            var r = e.length,
              o = new Array(r),
              n = e.map(function () {
            ...
            l(u);
          t.subscribe(
            new G.OperatorSubscriber(s, function (e) {
              if (a) {
      ...
      class ce {
        constructor({
          ...
          const I = null != _ ? _ : [];
          this._priceRules =
            null !== (f = I.filter(this._isPriceRules)) && void 0 !== f
              ? f
              : [];
          const D =
            ...
            .pipe(
              (0, H.operate)(function (e, t) {
                var i,
                  s = !1;
                e.subscribe(
                  new G.OperatorSubscriber(t, function (e) {
                    var r = i;
          ...
          ((this._priceStep = (0, w.getPriceStep)({
            ...
            (0, S.combineLatest)({
              ...
              .subscribe((t) => {
                ...
                null !== e
                  ? ((d = 1), (l = null), (u = e))
                  : ((l = null !== v ? v : this._getDefaultPips(s)),
                    (u = null));
                const {
                  pips: c,
                  price: h,
      ...
      function Le(e) {
        return (0, H.operate)(function (t, i) {
      ...
      class Re {
        ...
        getValue() {
          ...
          const i = { type: e.type };
          return (
            (t.hasDatePicker || t.hasTimePicker) && (i.datetime = e.datetime),
            i
          );
        }
      ...
      const We = " ",
        ...
        Ue = (e, t, s) =>
          u.t(null, void 0, i(518088)).format({
            qty: e,
            symbol: t,
            limitPrice: s,
        ...
        He = (e, t, s, r) =>
          u.t(null, void 0, i(828749)).format({
            qty: e,
            symbol: t,
            stopPrice: s,
            limitPrice: r,
      ...
      class _t {
        ...
        _doneHandler() {
          ...
          return (
            this._getAndSendStatistics(),
            this._handler(this.position.id, s)
          );
        }
      ...
      class Vt {
        constructor(e) {
          ((this._orderViewModel = null),
            ...
            (this._recreateOrderViewModel = async (e, t) => {
              ...
              if (null === l)
                ...
                const p = this._orderStub.hasOwnProperty("id")
          ...
          if (
            ...
            this._setDisplayMode(
              null != e ? e : T.OrderEditorDisplayMode.Panel,
            );
        ...
        _setSettings() {
          ...
          let t =
            this._orderViewDataStorage.getSettings() || Pt.defaultSettings;
