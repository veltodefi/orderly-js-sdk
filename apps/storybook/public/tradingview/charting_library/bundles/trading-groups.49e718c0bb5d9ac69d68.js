    ...
    16951: (e, t, i) => {
      ...
      async function R(e, t, r, s, o, a, n) {
        ...
        const c = {
          ...
          valueGetter: s,
          position: function (e) {
            return new G.Point(t.x - e.contentWidth, t.y);
          },
          targetEl: null,
      ...
      class $ extends M.TradedGroupBase {
        ...
        async modifyAllItems(e, t) {
          ...
          const S = this._hadBeenModifiedAllItems
            ...
            k = (function (e, t, i) {
              return (0, L.isPositionLikeItem)(i) || "Move Order" === e
                ? "group"
      ...
      class Q {
        ...
        async _findPositionRealIdByParentId(e) {
          ...
          if (void 0 !== t) i = t.id;
            ...
            return (
              null !== t && this._positionsRealToParentIds.delete(t),
              null
            );
          }
        ...
        _addOrderItems(e) {
          for (const t of e) {
            (this._removeSourceIfChangedParent(t),
              this._ordersData.set(t.id, t));
