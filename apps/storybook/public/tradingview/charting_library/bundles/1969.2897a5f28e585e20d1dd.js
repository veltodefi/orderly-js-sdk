      ...
      class H extends W {
        ...
        hitTest(t, e) {
          ...
          const p =
            ...
            (0, s.ensureDefined)(this._data.reverse);
          if (p && 1 === p.visibility) {
          ...
          const l = y(t, e),
            ...
            n =
              isFinite(a.pipSize) && a.pipSize !== a.minTick
                ...
                : v.integerFormatter,
            d =
              parseFloat(n.format(t / (a.pipSize || a.minTick))) *
              this._data.side;
        ...
        async onContextMenu(t, e) {
          ...
          const o = this._composeContextMenuActions(e),
            ...
            i = await (async function (t, e) {
              const o = [],
                r = await (0, f.createContextMenuTitle)(
                  "Trading.OrderTitle",
                  e,
                );
              r && o.push(r);
      ...
      class h extends n.OrderBaseItem {
        ...
        async onModify(t = {}, e, o) {
          ...
          (await this._addTrailingStopPipsData(s),
            this._trackEventGA(
              (0, a.mergeGaParams)(t, { event: "Edit Order" }),
            ));
    ...
    25412: (t, e, o) => {
      ...
      class P extends _.BaseItem {
        ...
        setData(t) {
          ...
          (super.setData(t),
            this.data().pl !== o && this.fireProfitLossChange());
        }
        qtyText() {
    ...
    483186: (t, e, o) => {
      ...
      class f extends h.OrderWithMenuItem {
        ...
        setPrice(t) {
          ...
          (null !== t &&
            (t = (0, i.fixComputationError)(e * Math.round(t / e))),
