  ...
  [4876],
  {
    ...
    664332: (t, e, i) => {
      ...
      var s = i(50959),
        ...
        r = i(718736);
      function o(t, e = []) {
        const { callback: i, ref: o = null } = (function (t) {
    ...
    476702: (t, e, i) => {
      ...
      class P {
        ...
        destroy() {
          var t;
          (this.remove(),
            null === (t = this._page) || void 0 === t || t.remove());
        }
      ...
      var J = i(892932),
        $ = i(865266),
        Q = i(359332);
      const tt = (0, o.forwardRef)(function (t, e) {
        const {
            theme: i = Q,
            className: s,
            name: n,
      ...
      class bt {
        ...
        createPage() {
          ...
          return (
            null === (t = this._pagescontent) || void 0 === t || t.append(i),
            e
          );
        }
        createWidget(t, e) {
      ...
      class Ht {
        ...
        getLayoutState() {
          ...
          return (
            (e.pages = e.pages.filter((t) => t.widgets && t.widgets.length)),
            e
          );
        }
        createWidgetId(t) {
          ...
          ((this._helper = null),
            ...
            (this._handleDragMove = (t) => {
              ...
              const { current: i, initial: s } = t.detail,
                ...
                o =
                  "y" === this._axis || !1 === this._axis || 0 !== i.movementY;
              if (o) {
    ...
    256928: (t, e, i) => {
      ...
      class u {
        ...
        scrollToStart() {
          return (
            this.setContentTop(this._headerHeight),
            this._onScroll(),
            this
          );
        }
