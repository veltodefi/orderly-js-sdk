  ...
  [4627],
  {
    ...
    73245: (t, e, i) => {
      ...
      class F {
        ...
        updateClassName(t) {
          ...
          ((d.className = `${N["tv-dom-widget-main__order"]} ${C["tv-dom-widget-order"]}`),
            ...
            d.classList.toggle(
              C["tv-dom-widget-order--notcanceled"],
              !1 === l,
            ));
        }
        collapse() {
      ...
      class H {
        ...
        repaint() {
          ...
          if (isFinite(e)) {
            ...
            for (const t in this._invalidatedBid)
              this._invalidatedBid.hasOwnProperty(t) &&
                delete this._invalidatedBid[t];
            for (const t in this._invalidatedAsk)
              this._invalidatedAsk.hasOwnProperty(t) &&
            ...
            for (const t in this._invalidatedOrders)
              this._invalidatedOrders.hasOwnProperty(t) &&
        ...
        _collectIndexes() {
          this._indexes = Object.keys(
            Object.assign({}, this._asks, this._bids),
          );
        }
        _recalcDepthInfo() {
        ...
        _updateRow(t) {
          ...
          this._viewPool &&
            !n &&
            ((n = this._viewPool.allocate()), r.set(t, n));
          ...
          (t.forEach((t) => {
            if ("ComboBox" === t.inputType) {
              ...
              if (void 0 !== i)
                ...
                (s.set(t.id, e),
                  e.subscribe(this._rewriteDisplayedSelectedItems));
              }
              e.push(t);
            }
          ...
          (h.appendChild(this._totalVolumeBidTextNode),
            ...
            a.addEventListener("click", (t) => {
              ...
              (a.setAttribute("title", n),
                ...
                l.appendChild(
                  (0, d.ensureNotNull)((0, I.parseHtmlElement)(r)),
                ));
            }),
        ...
        async _onStateChange() {
          const { symbol: t } = this._tradingLinking.value(),
            ...
            i =
              null == e
                ? void 0
                : e.metainfo().configFlags.calculatePLUsingLast;
          ...
          ((this._symbolData = l),
            ...
            (n.domHandler = (t, e) => {
              (this._content.updateData(e),
                this._scheduleUpdateViewTotalVolume());
            }));
        ...
        _updateViewTotalVolume() {
          if (((this._viewTotalVolumeScheduled = !1), this._symbolData)) {
            ...
            ((i.nodeValue = isFinite(t) ? this._content.formatVolume(t) : "-"),
              (s.nodeValue = isFinite(e)
                ? this._content.formatVolume(e)
                : "-"));
          }
        }
