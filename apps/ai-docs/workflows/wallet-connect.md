...
- Use `orderly_docs_get_package_surface` for `@veltodefi/hooks` to validate available wallet/account entry points.
...
- `orderly_docs_get_package_surface` for `@veltodefi/hooks`
