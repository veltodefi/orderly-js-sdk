...
- `@veltodefi/types` — shared types
- `@veltodefi/utils` — utilities including `Decimal`
- `@veltodefi/hooks` — React hooks for trading state
- `@veltodefi/ui` — presentational components
