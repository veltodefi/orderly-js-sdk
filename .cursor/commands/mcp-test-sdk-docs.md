...
description: Run MCP Inspector test workflow for @veltodefi/sdk-docs, including stdio-safe setup, core tool checks, negative cases, and triage for JSON framing errors.
