...
This document describes how to customize and extend the Orderly layout system using `@veltodefi/layout-core`. It covers the architecture, implementing custom layout strategies, integrating with the trading page, and plugin patterns.
...
```typescript
// myLayout/types.ts
import type { LayoutModel } from "@veltodefi/layout-core";
...
Standard IDs from `@veltodefi/layout-core`:

```typescript
import {
  TRADING_PANEL_IDS,
  getTradingPanelIds,
} from "@veltodefi/layout-core";
...
```typescript
import { LayoutRuleManager } from "@veltodefi/layout-core";
...
```typescript
import { useLayoutRuleManager } from "@veltodefi/layout-core";
...
```tsx
import { registerLayoutSplitPlugin } from "@veltodefi/layout-split";
import { getDefaultSplitPresets } from "@veltodefi/layout-split";
...
```tsx
import { getTradingPanelIds } from "@veltodefi/layout-core";
...
```typescript
import { resolveStrategy } from "@veltodefi/layout-core";
