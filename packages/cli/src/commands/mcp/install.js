...
function forwardToSdkDocs(argv) {
  ...
  console.log(
    chalk.dim("First run may download @veltodefi/sdk-docs; please wait."),
  );
  ...
  builder: (yargs) => {
    return yargs
      ...
      .option("sdk-docs-version", {
        type: "string",
        describe:
          "Pin @veltodefi/sdk-docs (semver or dist-tag, e.g. 0.1.0 or beta); applies to this run and merged MCP config",
      })
      .example(
