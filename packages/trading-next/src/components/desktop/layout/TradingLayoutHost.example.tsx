...
import { LayoutHost } from "@veltodefi/layout-core";

/** Strategy must be provided by the consumer, e.g. splitStrategy from @veltodefi/layout-split or gridStrategy from @veltodefi/layout-grid */
