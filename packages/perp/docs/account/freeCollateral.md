...
- **Upstream**: `@veltodefi/utils` (Decimal, zero). totalCollateral from totalCollateral(); totalInitialMarginWithOrders from totalInitialMarginWithQty() (cross only).

## freeCollateral Example

```typescript
import { freeCollateral } from "@veltodefi/perp";
