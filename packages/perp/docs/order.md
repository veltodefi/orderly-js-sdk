...
Order-related calculations: price bounds (max/min/scope), order fee, estimated liquidation price, estimated leverage, and TP/SL ROI. Depends on `@veltodefi/types`, `@veltodefi/utils`, and `positions.notional`.
