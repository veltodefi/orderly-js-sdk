...
Builds the reward history list by merging epoch info with wallet rewards and account rewards history. Computes claim state (Claimed / Claimable / Processing / Null) and optional `rewardsTooltip` per row. Uses pagination from `@veltodefi/ui`.
