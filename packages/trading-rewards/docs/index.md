...
This directory contains the source code for the **Trading Rewards** module (`@veltodefi/trading-rewards`). It provides layout, context, and page components for the trading rewards and affiliate rewards experience, including current epoch display, available-to-claim rewards, stake booster, and reward history.
