...
Hook that returns whether the current user can trade based on account status and app context (network, connect disabled). Uses `@veltodefi/hooks` and `@veltodefi/react-app`.
