...
| -------------- | -------------------------------------------- | -------- | ----------------------------------------------------- |
| newListingList | index.tsx, widget.tsx, _.ui.tsx, _.script.ts | TS/TSX   | New listing list UI and script                        |
| favoritesList  | index.tsx, widget.tsx, _.ui.tsx, _.script.ts | TS/TSX   | Favorites list UI and script                          |
| recentList     | index.tsx, widget.tsx, _.ui.tsx, _.script.ts | TS/TSX   | Recent list UI and script                             |
