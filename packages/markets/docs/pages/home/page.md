...
- **Upstream**: React, @veltodefi/i18n (useTranslation), @veltodefi/types (RouterAdapter), @veltodefi/ui (Box, cn, TabPanel, Tabs, useScreen), @veltodefi/ui-scaffold (LeftNavProps, LeftNavUI), MarketsProvider from components, MarketsPageTab from type.
