...
| routerAdapter    | RouterAdapter \| undefined | Optional router adapter from @veltodefi/types |
...
- **Upstream**: React (createContext, useContext, useState, useMemo); RouterAdapter from @veltodefi/types.
