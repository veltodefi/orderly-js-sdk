...
- **Upstream**: LayoutProvider (context), usePortfolioLayoutScriptType (layout.script), MainNavMobile, BottomNav, ScaffoldProps from @veltodefi/ui-scaffold; Flex, Box from @veltodefi/ui.
