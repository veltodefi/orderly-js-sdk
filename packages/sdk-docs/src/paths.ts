...
export function resolveAiDocsRepoRoot(
  ...
  throw new Error(
    "Could not resolve AI docs data root. Options: set ORDERLY_AI_DOCS_REPO_ROOT to a tree with apps/ai-docs/generated, work in a monorepo after `pnpm --filter @veltodefi/ai-docs generate`, or run `pnpm --filter @veltodefi/sdk-docs sync:bundle` before using the published package.",
  );
}
