...
export function getComponent(
  ...
  if (!record) {
    return errResult(
      ...
      "Regenerate AI docs (pnpm --filter @veltodefi/ai-docs generate).",
      bundle,
    );
  }
...
const PACKAGE_ALIASES: Record<string, string> = {
  layout: "@veltodefi/layout-core",
  "layout-core": "@veltodefi/layout-core",
  plugin: "@veltodefi/plugin-core",
  "plugin-core": "@veltodefi/plugin-core",
  ui: "@veltodefi/ui",
};
...
/**
 * Returns the indexed export surface for an npm package name (e.g. `@veltodefi/ui`).
 */
  ...
  if (!row || !Array.isArray(row.exports)) {
    return errResult(
      ...
      didYouMean?.length
        ...
        : "Use the full package name such as @veltodefi/layout-core.",
      bundle,
    );
  }
