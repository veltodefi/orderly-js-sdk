...
Main vaults page: wraps content in `VaultsProvider`, then renders lazy-loaded header, introduction, and all-vaults widgets. Layout is responsive (mobile vs desktop padding/gap) and uses `@veltodefi/ui` (cn, useScreen).
