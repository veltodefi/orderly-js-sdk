...
When running in a browser, `window.__ORDERLY_VERSION__["@veltodefi/ui-scaffold"]` is set to the current package version.

## Usage example

```typescript
import version from "@veltodefi/ui-scaffold/version";
// version === "2.9.1"

// In browser:
// window.__ORDERLY_VERSION__?.["@veltodefi/ui-scaffold"] === "2.9.1"
```
