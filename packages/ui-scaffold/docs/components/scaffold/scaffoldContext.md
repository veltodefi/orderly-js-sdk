...
React context for scaffold state: router adapter, expand state, chain support check, navbar/footer/announcement heights, and announcement state from `@veltodefi/ui-notification`.
