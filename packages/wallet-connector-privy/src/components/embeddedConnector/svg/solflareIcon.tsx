...
import { BaseIcon, BaseIconProps } from "@veltodefi/ui";

export const SolflareIcon = React.forwardRef<SVGSVGElement, BaseIconProps>(
  (props, ref) => {
    const { size = 32, ...rest } = props;
    return (
      <BaseIcon ref={ref} viewBox="0 0 50 50" size={size} {...rest}>
        <defs>
          <style>{".cls-1{fill:#02050a;}.cls-2{fill:#ffef46;}"}</style>
        </defs>
        <rect className="cls-2" width={50} height={50} rx={25} ry={25} />
        <path
          className="cls-1"
...
SolflareIcon.displayName = "SolflareIcon";
