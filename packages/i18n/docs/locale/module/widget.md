...
| ------ | ------ | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| widget | object | Key-value map | Keys under "assetHistory._", "linkDevice._", "settle._", "languageSwitcher._", "announcement._", "maintenance._", "restrictedInfo._", "subAccount._", "funding._", "leftNav._", "errorBoundary._", "dmm._" |
