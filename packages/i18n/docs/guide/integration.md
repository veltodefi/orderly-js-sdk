...
```tsx
import { LocaleProvider, useRegisterExternalResources } from "@veltodefi/i18n";
import type { AsyncResources, LocaleCode } from "@veltodefi/i18n";
...
```ts
import { registerDefaultResource } from "@veltodefi/i18n";
