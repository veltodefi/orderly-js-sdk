...
Formats a number for Y-axis tick labels using `numberToHumanStyle` from `@veltodefi/utils`, with decimal places based on magnitude and preserves sign (e.g. negative values get a minus prefix).
