...
The `@veltodefi/affiliate` package provides the referral/affiliate UI and logic for the Orderly Network: dashboard, referral codes, commission and referees, trader rebates, and home/landing flows.
