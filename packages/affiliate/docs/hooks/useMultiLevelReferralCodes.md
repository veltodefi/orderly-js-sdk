...
| --------------------------------- | -------- | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ReferralCodesRow                  | type     | Row shape   | code, direct*invites, indirect_invites, direct_volume, indirect_volume, direct_rebate, indirect_rebate, direct_bonus_rebate?, max_rebate_rate, referee_rebate_rate, referrer_rebate_rate, total*\*, referral_type |
...
- react (useMemo)
- @veltodefi/hooks (useRefereeInfo)
