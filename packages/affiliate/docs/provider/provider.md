...
- react, date-fns
- @veltodefi/hooks (RefferalAPI, usePrivateQuery, useDaily, useAccount, useMemoizedFn, noCacheConfig)
- @veltodefi/react-app (useAppContext)
...
```tsx
import { ReferralProvider } from "@veltodefi/affiliate";
