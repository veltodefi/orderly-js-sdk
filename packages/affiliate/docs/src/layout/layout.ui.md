...
`AffiliateLayout` wraps content in a scaffold with a left sidebar. Uses `@veltodefi/ui` Box and `@veltodefi/ui-scaffold` Scaffold/SideBar. Props extend `SideBarProps`.
