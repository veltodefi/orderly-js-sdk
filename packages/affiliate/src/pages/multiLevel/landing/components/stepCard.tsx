...
export const StepCard: FC<StepCardProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <Text size="xl" weight="semibold" className="oui-stepCard-title">
        {`${step}. ${title}`}
      </Text>

      {/* Description */}
      <Text intensity={54} size={"sm"} className="oui-stepCard-description">
        {description}
      </Text>
    </Flex>
  );
