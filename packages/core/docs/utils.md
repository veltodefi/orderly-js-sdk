...
Provides hashing, encoding, and time utilities for Orderly: parseBrokerHash, parseAccountId, parseTokenHash (keccak256/solidityPackedKeccak256), base64url, getTimestamp (with optional \_\_ORDERLY_timestamp_offset), formatByUnits, isHex, isHexString, getGlobalObject. Re-exports parseUnits from ethers.
...
| getTimestamp        | function  | Time     | Date.now() or Date.now() + \_\_ORDERLY_timestamp_offset                            |
