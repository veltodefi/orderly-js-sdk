...
const sheetVariants = tv({
  base: "oui-fixed oui-z-50 oui-gap-4 oui-bg-surface-background-medium-dark oui-px-4 oui-shadow-lg oui-transition oui-ease-in-out data-[state=closed]:oui-duration-260 data-[state=open]:oui-duration-300 data-[state=open]:oui-animate-in data-[state=closed]:oui-animate-out",
  variants: {
    side: {
