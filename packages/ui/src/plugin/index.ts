...
/**
 * Re-export plugin system from @veltodefi/plugin-core for backward compatibility.
 * @deprecated Import from @veltodefi/plugin-core directly for new code
 */
export {
  installExtension,
  setExtensionBuilder,
