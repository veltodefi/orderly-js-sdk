...
| version.ts  | TypeScript | Package version and `window.__ORDERLY_VERSION__` for @veltodefi/ui      | [version.md](version.md) |

## Search Keywords / Aliases

- orderly ui, @veltodefi/ui, UI package, component library
