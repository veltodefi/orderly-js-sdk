...
Canvas-based poster component. Uses `usePoster` from `@veltodefi/hooks` with `DrawOptions`; exposes ref methods for download, toDataURL, toBlob, and copy (e.g. clipboard).
