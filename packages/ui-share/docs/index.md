...
|------|----------|-------------|
| [version](./version.md) | TypeScript | Exposes package version and sets `window.__ORDERLY_VERSION__['@veltodefi/ui-share']`. |
| [entry](./entry.md) | TypeScript | Package entry: registers Share PnL dialog/sheet with `@veltodefi/ui`, re-exports sharePnL and types. |
